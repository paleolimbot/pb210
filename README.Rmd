...
[![Travis build status](https://travis-ci.org/paleolimbot/pb210.svg?branch=master)](https://travis-ci.org/paleolimbot/pb210) [![Coverage status](https://codecov.io/gh/paleolimbot/pb210/branch/master/graph/badge.svg)](https://codecov.io/github/paleolimbot/pb210?branch=master) [![lifecycle](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://www.tidyverse.org/lifecycle/#experimental)
...
You have some lead-210 measurements, but you want dates! Included are some lead-210 measurements from [Alta Lake, Whistler, British Columbia](http://doi.org/10.1007/s10933-016-9919-x).
...
alta_pb210_plot <- alta_pb210_plot +
  ...
  annotate(
    "rect", 
    xmin = -Inf, xmax = Inf,
    ymin = 32.45 - 7.38, ymax = 32.45 + 7.38,
    alpha = 0.3
  )
...
To test the package, I included a core simulator, which may be useful to help me improve this package.
